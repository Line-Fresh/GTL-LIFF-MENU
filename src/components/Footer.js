...
const Bottom = (props) => {
  ...
  return (
    <div style={{width: '100%', height: '100px', position:'fixed', bottom:-30}}>
      <div style={{marginTop: 20, borderRadius:"50%", width: "65px", height: "65px", backgroundColor:"white", position:'absolute', left:"50%", transform: "translate(-50%,-50%)", boxShadow:'0 -20px 20px -20px #9E9E9E' }}
      ...
      <div style={{width: '100%', height: '80px', borderRadius: '25px', marginTop:10, boxShadow:'0px 0px 20px #9E9E9E', paddingTop: 20}}>
        ...
        <Calendar color={state==="reservation&schedule"? 'DodgerBlue': 'grey'} size={state==="reservation&schedule"? '23px': '20px'} style={{marginLeft: "10%", float: "left"}} onClick={() => (setState('reservation&schedule'))}/>
